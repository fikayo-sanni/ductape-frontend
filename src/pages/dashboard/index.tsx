...
import { ConfigProvider, theme, Tabs, Typography } from 'antd';
                ...
                <div className="row">
                    <div className="col-lg-3">
                        <div className="animated bg-white slideInDown p-4 border_radius">
                            <h4 className="m-0 text-dark font-xs text-uppercase bold">Apps</h4>
                            <br />
                    ...
                    <div className="col-lg-3">
                        <div className="animated bg-white slideInDown  p-4 border_radius">
                            <p className="m-0 text-dark font-xs text-uppercase bold">Integrations</p>
                            <br />
                            <h1 className="m-0 font-weight-700">26</h1>
                            <br />
                            <div className="row">
                                <div className="col-3">
                                    <label style={{ color: '#00875A' }} className="bold">
                                        13
                                    </label>
                                ...
                                <div className="col-4">
                                    <label style={{ color: '#DC3444' }} className="bold">
                                        13
                                    </label>
                    ...
                    <div className="col-lg-3">
                        <div className="animated bg-white slideInDown  p-4 border_radius">
                            <p className="m-0 text-dark font-xs text-uppercase bold">Requests</p>
                            <br />
                    ...
                    <div className="col-lg-3">
                        <div className="animated bg-white slideInDown  p-4 border_radius">
                            <p className="m-0 text-dark font-xs text-uppercase bold">Webhooks</p>
                            <br />
