...
import { ConfigProvider, theme, Tabs, Typography, Card, Breadcrumb, Button, Statistic } from 'antd';
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3">
                        <Card className="bg-white">
                            <Statistic
                                className="font-black"
                                title={<Text className="font-gray font-weight-500 text-uppercase">Integrations</Text>}
                                value={112893}
                                formatter={formatter}
                            />
                        </Card>
