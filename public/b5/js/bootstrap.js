...
(function (global, factory) {
    ...
    /**
     * --------------------------------------------------------------------------
     * Bootstrap (v5.0.0-beta1): util/getStarted.tsx
     * Licensed under MIT (https://github.com/twbs/bootstrap/blob/main/LICENSE)
     * --------------------------------------------------------------------------
     */
    var MAX_UID = 1000000;
    ...
    var Tooltip = /*#__PURE__*/ (function (_BaseComponent) {
        ...
        _proto.getTitle = function getTitle() {
            ...
            if (!title) {
                title =
                    typeof this.config.title === 'function' ? this.config.title.call(this._element) : this.config.title;
            }
        ...
        _proto._activate = function _activate(target) {
            ...
            if (link.classList.contains(CLASS_NAME_DROPDOWN_ITEM)) {
                ...
                SelectorEngine.parents(link, SELECTOR_NAV_LIST_GROUP).forEach(function (listGroup) {
                    ...
                    SelectorEngine.prev(listGroup, SELECTOR_NAV_LINKS + ', ' + SELECTOR_LIST_ITEMS).forEach(function (
                        item,
                    ) {
